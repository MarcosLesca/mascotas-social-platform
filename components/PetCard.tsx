...
const PetCard: React.FC<PetCardProps> = ({ pet, onAction, onViewDetails, onShare }) => {
          ...
          <div className="relative overflow-visible">
            ...
            {showShareMenu && (
              <>
                ...
                {/* Modal */}
                <div ref={shareMenuRef} className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[320px] max-w-[90vw] bg-white dark:bg-background-dark rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                  {/* Header con imagen */}
                  <div className="relative h-32">
                    ...
                    <div className="absolute bottom-2 left-3 right-3">
                      <p className="text-white font-bold text-sm truncate">{pet.name}</p>
                      <p className="text-white/80 text-xs truncate">{isLost ? `Perdido en ${pet.location}` : pet.location}</p>
                    </div>
                  </div>
