        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-3">
              <Link 
                href="/perdidas"
                className="px-4 py-2 text-gray-600 hover:text-rose-600 hover:bg-rose-50 rounded-xl font-medium transition-all duration-200"
              >
                Perdidas
              </Link>
              <Link 
                href="/adopcion"
                className="px-4 py-2 text-gray-600 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl font-medium transition-all duration-200"
              >
                Adopción
              </Link>
              <Link 
                href="/donaciones"
                className="px-4 py-2 text-gray-600 hover:text-sky-600 hover:bg-sky-50 rounded-xl font-medium transition-all duration-200"
              >
                Ayuda
              </Link>
            </div>
            ...
            {/* Mobile Menu Toggle */}
            <button className="p-3 rounded-xl hover:bg-neutral-50 transition-all duration-200 border border-neutral-200 lg:hidden">
