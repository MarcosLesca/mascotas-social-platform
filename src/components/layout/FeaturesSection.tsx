...
const features = [
  {
    ...
    description:
      "Publica y busca mascotas perdidas en San Justo con responsabilidad y compromiso",
    href: "/perdidas",
  ...
  },
  {
    ...
    description:
      "Encuentra un hogar amoroso para mascotas que necesitan una segunda oportunidad",
    href: "/adopcion",
  ...
  },
  {
    ...
    description:
      "Coordina donaciones y asistencia para el cuidado de mascotas vulnerables",
    href: "/donaciones",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light">
            Ofrecemos una plataforma integral y responsable para diferentes
            necesidades de nuestra comunidad animal
          </p>
        </div>
