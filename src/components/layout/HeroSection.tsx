      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center space-y-8 max-w-5xl mx-auto">
          <ScrollAnimation animation="fadeInDown">
            {/* Trust Badge */}
            <div className="inline-flex items-center space-x-2 bg-emerald-100 mt-6 text-emerald-800 px-6 py-3 rounded-full text-sm font-medium hover-lift interactive">
              <span>Web Confiable y Responsable</span>
            </div>
          </ScrollAnimation>
            ...
            <div className="space-y-6">
              ...
              <div className="max-w-4xl mx-auto">
                <p className="text-xl md:text-2xl lg:text-3xl text-gray-600 leading-relaxed font-light">
                  ...
                  por <b>L&M Desarrollo Web</b>, pensado para generar un impacto
          ...
          <ScrollAnimation animation="fadeInUp" delay={400}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto py-8">
              <div className="text-center group hover-lift">
                <div className="text-3xl md:text-4xl font-bold text-emerald-600 group-hover:scale-110 transition-transform">
                  500+
                </div>
                <div className="text-gray-600 font-medium">Reencuentros</div>
              </div>
              <div className="text-center group hover-lift">
                <div className="text-3xl md:text-4xl font-bold text-sky-600 group-hover:scale-110 transition-transform">
                  200+
                </div>
                <div className="text-gray-600 font-medium">Adopciones</div>
              </div>
              <div className="text-center group hover-lift">
                <div className="text-3xl md:text-4xl font-bold text-rose-600 group-hover:scale-110 transition-transform">
                  1000+
                </div>
          ...
          <ScrollAnimation animation="fadeInUp" delay={600}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
              ...
              >
                <span className="relative z-10">Publicar mascota perdida</span>
                <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
              </Link>
              <Link
                href="/publicar"
                className="group relative bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 overflow-hidden btn-shine interactive"
              >
                <span className="relative z-10">Ayudar / Donar</span>
                <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
              </Link>
            </div>
