...
import {
  ...
  fetchApprovedAdoptionPetReports,
...
const AdminAdoptionPets: React.FC = () => {
  ...
  const [approvedReports, setApprovedReports] = useState<AdoptionPetReportRow[]>([]);
  ...
  const loadApproved = useCallback(() => {
    ...
    fetchApprovedAdoptionPetReports().then(({ data, error: e }) => {
              ...
              <button
                ...
                onClick={async () => {
                  if (confirmAction.type === 'delete') {
                    ...
                    const { error: e } = await rejectAdoptionPetReport(confirmAction.reportId, user.id);
                    setActing(null);
                    setConfirmAction(null);
                    if (e) {
                      setError(e.message);
