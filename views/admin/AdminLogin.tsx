      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-slate-900/80 rounded-2xl shadow-xl border border-accent-teal/10 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="admin-email" className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1.5">
                Email
              </label>
              <input
                id="admin-email"
                ...
                className={`w-full px-4 py-3 rounded-xl border bg-slate-50 dark:bg-slate-800/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent disabled:opacity-60 ${
                  errors.email ? 'border-urgent-red' : 'border-accent-teal/20'
                }`}
                placeholder="admin@petwelfare.org"
            ...
            <div>
              <label htmlFor="admin-password" className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1.5">
                Contraseña
              </label>
              <div className="relative">
                <input
                  ...
                  disabled={submitting || rateLimit.blocked}
                  className={`w-full px-4 py-3 pr-12 rounded-xl border bg-slate-50 dark:bg-slate-800/50 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent disabled:opacity-60 ${
                    errors.password ? 'border-urgent-red' : 'border-accent-teal/20'
                  }`}
                  placeholder="••••••••"
              ...
              {errors.password && (
                <p id="password-error" className="mt-1.5 text-sm text-urgent-red">
                  {errors.password}
                </p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={submitting || rateLimit.blocked}
              className="w-full py-3.5 rounded-xl bg-primary hover:bg-primary/90 text-background-dark font-bold transition-colors disabled:opacity-60 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-900"
            >
              {submitting ? (
          ...
          <p className="mt-6 text-center">
            <Link
              to="/"
              className="text-sm font-medium text-accent-teal hover:text-primary transition-colors"
            >
              ← Volver al inicio
            </Link>
          </p>
